...
from utils.optimization.optimizer_evaluation import OptimizerEvaluation
from utils.optimization.optimizer_tool import choose_optimizer, early_condition, load_model, select_metric
from utils.optimization.optimizer_tool import load_search_space, plot_bayesian_optimization, plot_model_runs
...
class Optimizer:
    ...
    def optimize(self, model, dataset, metric, search_space, extra_metrics=None,
        ...
        """
        Perform hyper-parameter optimiza for a Topic Model
        ...
        :param metric: metric used for the optimiza
        ...
        :param extra_metrics: list of extra-metrics to compute during the optimiza
        ...
        :type optimiza type: str, optional
        :param model_runs:
        :type: int, optional
        ...
        :type: list, optional
        :param save_models: if 'True' save all the topic models generated during the optimiza process
        :type: bool, optional
        :param save_step: decide how much to save the results of the optimiza
        :type: int, optional
        :param save_name: name of the file where the results of the optimiza will be saved
        :type: str, optional
        :param save_path: Path where the results of the optimiza (json file) will be saved
        :type save_path: str, optional
        :param early_stop: if "True" stop the optimiza if there is no improvement after early_step evaluations
        :type early_stop: bool, optional
        :param early_step: number of iterations with no improvement after which optimiza will be stopped (if early_stop is True)
    ...
    def resume_optimization(self, name_path, extra_evaluations=0):
        """
        Restart the optimiza from the json file.

        :param name_path: path of the json file
        :type name_path: str
        :param extra_evaluations: extra iterations for the BO optimiza
        :type extra_evaluations: int
        :return: object with the results of the optimiza
        :rtype: object
        """
    ...
    def _objective_function(self, hyperparameter_values):
        ...
        # Compute the score of the hyper-parameter config
    ...
    def _optimization_loop(self, opt):
        """
        Perform the optimiza through Bayesian Optimization

        :return: result of the optimiza
        :rtype: class
        """
        results = None
        ...
        for i in range(self.number_of_previous_calls, self.number_of_call):
            ...
            # Create an object related to the BO optimiza
    ...
    def _load_metric(self, optimization_object, dataset):
        ...
        :param optimization_object: dictionary of the information saved during the optimiza
    ...
    def _restore_parameters(self, name_path):
        ...
        :type name_path: str
        :return: result of BO optimiza (scikit-optimize object), surrogate model (scikit-learn object)
        :rtype: tuple
        """
    ...
    def _check_bo_parameters(self):
        ...
        if self.optimization_type not in ['Maximize', 'Minimize']:
            print("Error: optimiza type must be Maximize or Minimize")
            return -1
